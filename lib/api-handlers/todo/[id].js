...
module.exports = async (req, res) => {
    ...
    try {
        ...
        if (req.method === 'PUT') {
            const { title, completed, dueDate, order, serialNumber, priority, description, subtasks, estimatedTime, recurrence, recurrenceDays, recurrenceUntil, scheduledAt, tags } = req.body || {};
