    ...
    try {
        ...
        if (req.method === 'PUT') {
            ...
            const allowedFields = [
                ...
                'website', 'linkedin', 'howMet', 'whereMet', 'dateMet', 'mutualConnections',
                'category', 'notes', 'lastContacted', 'nextFollowUpAt', 'followUpDueDate', 'followUpScheduledDate', 'followUpStatus', 'followUpNotes', 'syncTodo', 'todoId'
            ];
